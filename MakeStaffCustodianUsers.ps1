...
$UserList=IMPORT-CSV D:\CreateStaffUsers\StaffCustodian.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Add-ADGroupMember -Identity "PCTI Custodial Maintenance" -Members $Username
