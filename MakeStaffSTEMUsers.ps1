...
$UserList=IMPORT-CSV D:\CreateStaffUsers\StaffSTEM.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/Teachers’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Add-ADGroupMember -Identity "PCTI STEM Teachers" -Members $Username
Add-ADGroupMember -Identity "PCTI High School Teachers" -Members $Username
