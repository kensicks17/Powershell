...
$UserList=IMPORT-CSV D:\CreateStaffUsers\NewSubs.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/Substitutes’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Add-ADGroupMember -Identity "PCTI Substitutes" -Members $Username
