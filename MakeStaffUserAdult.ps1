...
$UserList=IMPORT-CSV D:\CreateStaffUsers\StaffAdult.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/Adult And Continuing Education’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Add-ADGroupMember -Identity "PCTI Adult And Continuing Education" -Members $Username
