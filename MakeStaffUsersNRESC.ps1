...
$UserList=IMPORT-CSV D:\CreateStaffUsers\StaffNRESC.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/NRESC’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Set-ADUser $Username -ProfilePath \\pcti.tec.nj.us\dfs\pdirs\StaffPCESC\$Username
...
Add-ADGroupMember -Identity "PCESC Staff" -Members $Username
Add-ADGroupMember -Identity "Transportation" -Members $Username
