...
$UserList=IMPORT-CSV E:\CreateStaffUsers\NewStaff2018_Security.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/Security’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
...
Add-ADGroupMember -Identity "PCTI All High School Staff" -Members $Username
