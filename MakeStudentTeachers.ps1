...
$UserList=IMPORT-CSV D:\CreateStaffUsers\StudentTeachers.csv
...
NEW-QADUSER –FirstName $Person.Firstname –Lastname $Person.Lastname –Name $Name –SamAccountName $Username –UserPassword $Password –UserPrincipalName $UPN –ParentContainer ‘pcti.tec.nj.us/Staff/Teachers/Student Teachers’ -DisplayName $Name -Mail $Username"@pcti.pcti.tec.nj.us"
